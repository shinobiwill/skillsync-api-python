...
class AIService:
    ...
    async def analyze_compatibility(
        self, resume_analysis: Dict[str, Any], job_analysis: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def generate_cover_letter(
        ...
        try:
            ...
            prompt = ai_settings.COVER_LETTER_PROMPT.format(tone=tone, length=length)
    ...
    async def suggest_improvements(
        self, resume_analysis: Dict[str, Any], target_role: str
    ) -> List[str]:
    ...
    async def generate_interview_questions(
        self, job_analysis: Dict[str, Any], resume_analysis: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
