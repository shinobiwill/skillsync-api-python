...
from schemas.requests.requests import (
    UserRegisterRequest,
    UserLoginRequest,
    UserUpdateRequest,
)
...
class UserService:
    ...
    async def verify_token(self, token: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return {"user_id": user_id, "email": payload.get("email"), "user": user}
    ...
    async def change_password(
        ...
        try:
            ...
            success = await self.user_repo.update_user(
    ...
    async def get_user_statistics(self, user_id: UUID) -> Dict[str, Any]:
        ...
        try:
            ...
            activity_stats = await self.activity_repo.get_activity_statistics(
                str(user_id)
            )
